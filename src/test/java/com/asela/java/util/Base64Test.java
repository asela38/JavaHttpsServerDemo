...
public class Base64Test {
	...
	static {
		...
		ranges.forEach((F,T) ->
			RFC4648_ALPHABET.putAll( 
					...
					.boxed()
					.collect(Collectors.toMap(k -> index.getAndIncrement(), v -> new Character((char)v.intValue())))
			)
		);
	...
	public void manualBase64EncodingNonPaddingCase() throws Exception {
		...
		String subjectInBinary = IntStream
		...
		String base64String = Arrays.stream(split)
